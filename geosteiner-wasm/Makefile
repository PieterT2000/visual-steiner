...
CC = /Users/piet/Documents/cli-tools/emsdk/upstream/emscripten/emcc
OPTFLAGS = -O3
WERROR_FLAG = 
RANLIB	= /Users/piet/Documents/cli-tools/emsdk/upstream/emscripten/emranlib
AR	= /Users/piet/Documents/cli-tools/emsdk/upstream/emscripten/emar

# Force libtool to use C language conventions, rather than letting it
# try to guess which language we are using.
LIBTOOL = /opt/homebrew/bin/glibtool --tag=CC
