...
\begin{tikzpicture}[line cap=round,line join=round,x=9cm,y=9cm]
    ...
    % Collapse E,S3,D into X

    \draw [dashed,gray!40] (-0.1742873948409729,0.09281770574273644) circle (0.11);
    ...
    \begin{tiny}
        ...
        \draw (-0.2813609509364418,0.07031712226437783) node[circle,draw=gray!40, fill=gray!40, scale=0.6] (E) [label={[xshift=-0.25cm, yshift=-0.5cm]$E$}] {};

        \draw (-0.1,0.01) node[circle,draw=black, fill=black, scale=0.6] (X) [label={[yshift=-0.5cm]$X$}] {};
        % Steiner points
